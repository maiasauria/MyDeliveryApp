...
class ProductRepositoryImpl : ProductRepository {
    ...
    override fun getProducts(): List<com.mleon.core.model.Product> = products

    override fun filterProducts(nombre: String): List<com.mleon.core.model.Product> {
